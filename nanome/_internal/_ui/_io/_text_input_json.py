...
def parse_json(content_json):
    ...
    text_input._max_length = content_json.read("max_length", 0)
    text_input._placeholder_text = content_json.read("placeholder_text", "")
    text_input._input_text = content_json.read("input_text", "")
    return text_input
