...
def parse_json(content_json):
    ...
    button._icon._color_idle = Color.from_int(int(float(read_attribute_safe(content_json, "icon_color_idle", '4294967295'))))
    button._icon._color_selected = Color.from_int(int(float(read_attribute_safe(content_json, "icon_color_selected", '4294967295'))))
    button._icon._color_highlighted = Color.from_int(int(float(read_attribute_safe(content_json, "icon_color_highlighted", '4294967295'))))
    button._icon._color_selected_highlighted = Color.from_int(int(float(read_attribute_safe(content_json, "icon_color_selected_highlighted", '4294967295'))))
    button._icon._color_unusable = Color.from_int(int(float(read_attribute_safe(content_json, "icon_color_unusable", '4294967295'))))
