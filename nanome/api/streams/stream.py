...
class Stream(object):
    ...
    def update(self, data, done_callback=None):
        ...
        """
        id = self.__network._send(Messages.stream_feed, (self.__id, data, self.__data_type), done_callback is not None)
    ...
    def destroy(self):
        ...
        self.__network._send(Messages.stream_destroy, self.__id, False)
