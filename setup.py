...
setup(
    ...
    entry_points={"console_scripts": ["nanome-setup-plugins = nanome.setup_config:main", "nanome-plugin-init = nanome.plugin_init:main"]},
    package_data={"nanome": ["_internal/_process/_external/_dssp/*", "plugin-template.zip"]},
)
