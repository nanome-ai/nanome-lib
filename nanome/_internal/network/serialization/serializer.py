...
# workspace
add_message(CommandCallbacks.Messages.workspace_update, CommandSerializers._UpdateWorkspace())
add_message(CommandCallbacks.Messages.structures_deep_update, CommandSerializers._UpdateStructures(False))
add_message(CommandCallbacks.Messages.structures_shallow_update, CommandSerializers._UpdateStructures(True))
add_message(CommandCallbacks.Messages.workspace_request, CommandSerializers._RequestWorkspace())
add_message(CommandCallbacks.Messages.complex_list_request, CommandSerializers._RequestComplexList())
add_message(CommandCallbacks.Messages.add_to_workspace, CommandSerializers._AddToWorkspace())
add_message(CommandCallbacks.Messages.complexes_request, CommandSerializers._RequestComplexes())
add_message(CommandCallbacks.Messages.bonds_add, CommandSerializers._AddBonds())
add_message(CommandCallbacks.Messages.dssp_add, CommandSerializers._AddDSSP())
add_message(CommandCallbacks.Messages.structures_zoom, CommandSerializers._PositionStructures())
add_message(CommandCallbacks.Messages.structures_center, CommandSerializers._PositionStructures())
add_message(CommandCallbacks.Messages.hook_complex_updated, CommandSerializers._ComplexUpdatedHook())
add_message(CommandCallbacks.Messages.hook_selection_changed, CommandSerializers._SelectionChangedHook())
add_message(CommandCallbacks.Messages.compute_hbonds, CommandSerializers._ComputeHBonds())
add_message(CommandCallbacks.Messages.substructure_request, CommandSerializers._RequestSubstructure())

# volume
add_message(CommandCallbacks.Messages.add_volume, CommandSerializers._AddVolume())

# ui
add_message(CommandCallbacks.Messages.menu_update, CommandSerializers._UpdateMenu())
add_message(CommandCallbacks.Messages.content_update, CommandSerializers._UpdateContent())
add_message(CommandCallbacks.Messages.node_update, CommandSerializers._UpdateNode())
add_message(CommandCallbacks.Messages.menu_transform_set, CommandSerializers._SetMenuTransform())
add_message(CommandCallbacks.Messages.menu_transform_request, CommandSerializers._GetMenuTransform())
add_message(CommandCallbacks.Messages.notification_send, CommandSerializers._SendNotification())
add_message(CommandCallbacks.Messages.hook_ui_callback, CommandSerializers._UIHook())

# files
add_message(CommandCallbacks.Messages.print_working_directory, CommandSerializers._PWD())
...
# macros
add_message(CommandCallbacks.Messages.run_macro, CommandSerializers._RunMacro())
add_message(CommandCallbacks.Messages.save_macro, CommandSerializers._SaveMacro())
add_message(CommandCallbacks.Messages.delete_macro, CommandSerializers._DeleteMacro())
add_message(CommandCallbacks.Messages.get_macros, CommandSerializers._GetMacros())
add_message(CommandCallbacks.Messages.stop_macro, CommandSerializers._StopMacro())

# streams
add_message(CommandCallbacks.Messages.stream_create, CommandSerializers._CreateStream())
add_message(CommandCallbacks.Messages.stream_feed, CommandSerializers._FeedStream())
add_message(CommandCallbacks.Messages.stream_destroy, CommandSerializers._DestroyStream())

# Presenter
add_message(CommandCallbacks.Messages.presenter_info_request, CommandSerializers._GetPresenterInfo())
add_message(CommandCallbacks.Messages.controller_transforms_request, CommandSerializers._GetControllerTransforms())

# Shape
add_message(CommandCallbacks.Messages.set_shape, CommandSerializers._SetShape())
add_message(CommandCallbacks.Messages.delete_shape, CommandSerializers._DeleteShape())

# others
add_message(CommandCallbacks.Messages.open_url, CommandSerializers._OpenURL())
add_message(CommandCallbacks.Messages.load_file, CommandSerializers._LoadFile())
add_message(CommandCallbacks.Messages.integration, CommandSerializers._Integration())
add_message(CommandCallbacks.Messages.set_skybox, CommandSerializers._SetSkybox())
add_message(CommandCallbacks.Messages.apply_color_scheme, CommandSerializers._ApplyColorScheme())

# files deprecated
add_message(CommandCallbacks.Messages.directory_request, CommandSerializers._DirectoryRequest())
add_message(CommandCallbacks.Messages.file_request, CommandSerializers._FileRequest())
