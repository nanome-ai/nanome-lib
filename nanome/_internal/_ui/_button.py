...
class _Button(_UIBase):
    ...
    def _register_hover_callback(self, func):
        ...
        try:
            nanome._internal._network._ProcessNetwork._instance._send(
                nanome._internal._network._commands._callbacks._Messages.hook_ui_callback, (nanome._internal._network._commands._serialization._UIHook.Type.button_hover, self._content_id), False
            )
        except:
    ...
    class _ButtonOutline(object):
        ...
        def __init__(self):
            self._active = True
            self._size = _Button._MultiStateVariable._create(0.3)
    ...
    class _ButtonTooltip(object):
        ...
        def __init__(self):
            self._title = ""
            self._content = ""
            self._bounds = Vector3(1.73, 0.6, 0.05)
